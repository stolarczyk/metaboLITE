...
nodes <- read.csv("data/Data files/Dataset1-Media-Example-NODES.csv", header=T, as.is=T)
links <- read.csv("data/Data files/Dataset1-Media-Example-EDGES.csv", header=T, as.is=T)
